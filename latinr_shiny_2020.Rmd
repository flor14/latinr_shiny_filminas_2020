...
[¡Click de descarga aquí!](https://shiny.rstudio.com/articles/cheatsheet.html)
...
Estructura de una app con dos pestañas. Dentro de cada pestaña hay una barra lateral y un panel principal
...
# Chequear que el código corre de antemano ✅
...
class: center, middle, inverse
### 🔌 Conecta la elección del usuarie en el input con el código en el servidor, y luego el código del servidor con la salida del código 🤔🤯
...
class: center, middle, inverse
# 🔌 Conecta la elección en pantalla del usuarie con el código en el servidor ✅



---
## Referite a los valores de entrada (*inputs*) usando `input$<id>`
...
[Blog en español para aprender a usar Binder en tu Shiny app](https://florencia.netlify.app/es-es/2020/08/compartiendo-entornos-interactivos-y-reproducibles-en-r-con-binder.es-es/)
